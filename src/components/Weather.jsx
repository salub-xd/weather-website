        ...
        <div>
            <div className="contactForm">
                <form id="contacts" className="form">
                    <h2>Search Here</h2>
                    <p type="City"><input type='text' id="value" name="value" placeholder="Write Your City.." value={myFormValue} onChange={onChange} ></input></p>
            ...
            <div className="error">
                <h2 style={myEffect ? { display: "none" } : { display: "block" }} >{myValue.message}</h2>
            </div>
            <div style={myEffect ? { display: "flex" } : { display: "none" }} className='cards'>
                <div className='card'>
                    <div className="cardBox">
                        <div className="cardImg">
                            <img
                                ...
                                // src={() => {
                                    // if (myValue.id && myValue.weather.map((elm) => {
                        ...
                        <div className="cardText">
                            ...
                            <p className='line'>{myValue && <span>{myValue.name}, </span>}{myValue.sys && <span>{myValue.sys.country}</span>} </p>
                            <h3>  {myValue.main && <span className='lineVr'> Humidity =  {myValue.main.humidity} </span>}  {myValue.main && <span> Wind =  {myValue.wind.speed} </span>}</h3>
                        </div>
                        {/* <div className="btn">
